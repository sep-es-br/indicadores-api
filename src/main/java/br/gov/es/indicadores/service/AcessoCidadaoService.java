...
import br.gov.es.indicadores.client.AcessoCidadaoTokenClient;
import br.gov.es.indicadores.client.AcessoCidadaoWebClient;
import br.gov.es.indicadores.dto.acessocidadaoapi.AgentePublicoACDto;
...
public class AcessoCidadaoService {
    ...
    private Map<String, Object> getTokenClientHeaders(String basicToken) {
        ...
        headers.put(AUTHORIZATION, "Basic " + Base64.getEncoder().encodeToString(basicToken.getBytes(StandardCharsets.UTF_8)));
